...
def main():
    ...
    with open(file_name, "a") as file:
        ...
        for i in range(num_sims):
            ...
            file.write(f"\tLOCAL python3 $(WORK_DIR)/utils/csv_logger.py $(WORKFLOW_NUMBER) openfoam_{i} completed $(STATUS_FILE) && touch $(WORKFLOW_LOCATION)/simulations/of_sim.{i}.done\n\n")
